#' Chunked \code{spacy_parse}
#'
#' A wrapper for spacy_parse, but with chunking for large datasets
#'
#' @param texts Character vector of texts
#' @param ids Character vector of identifiers for each text
#' @param chunk Boolean, whether to chunk or not. Will decide on its own if left at NULL.
#' @return spacy parsed data.table
#' @export
...
#' Preprocessing
#'
#' Wrapper for various preprocessing steps
#'
#' @param parsed Object returned by \code{spacy_parse_chunk}
#' @param custom_nouns Character vector of (proper) nouns to keep
#' @return Quanteda tokens object
#' @export
...
#' Preprocessing
#'
#' Wrapper for the two preprocessing steps
#'
#' @param texts Character vector of texts
#' @param ids Character vector of identifiers for each text
#' @param chunk Boolean, whether to chunk or not. Will decide on its own if left at NULL.
