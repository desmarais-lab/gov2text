#' Read website files
#'
#' A Function to automatically read and convert to text the files in the given directory and sub-directories.
#'
#' @param str The directory in which the files reside. Sub-directories will also be accessed
#' @return data table object with two columns - file id and text
#' @export
